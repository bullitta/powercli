...
$DATASTORE = "C_CAMPUS_COMP_LUN001_HITACHI_SHARED"
$VMHOST = Get-VMHost -name crm1com*esx01*
$Folder = Get-Folder -Name Templates
$PORTGROUP = Get-VDPortgroup -name vxw-dvs-90-virtualwire-8-sid-5006-CAMPUS-NP-LS-CERT-02
